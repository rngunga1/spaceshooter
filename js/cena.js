 ...
 */
 ...
 function animate() {
   ...
   listaNaveViloes.forEach((element) => {
     ...
     if (element.nave.position.z <= plano.planoEsquerdaBox.zMin || element.nave.position.z > 350) {
       if (element.nave.position.z <= plano.planoEsquerdaBox.zMin) {
         element.nave.position.z = plano.planoEsquerdaBox.zMin;
       } else if (element.nave.position.z > 350) {
         element.nave.position.z = 350;
       }
